<template>
  <div class="container">
    <div class="top-head"><Icon class="top-left-icon" size="20" type="ios-home-outline" /><span>当前位置:</span><span>系统设置</span>&gt;<span>菜单管理</span></div>
    <div class="search">
      ...
      <Button type="primary" class="add" @click="add=true">添加菜单</Button>
    </div>
 ...
 <!--   <div class="page">
    ...
    <Modal class="change-modal"
           ...
           :mask-closable="false">
      <p><span class="first-title">站点名称:</span><Input v-model="this.addData.name" size="large" placeholder="站点名称" style="width: 200px" /></p>
      <p><span class="first-title">站点地点:</span><Input v-model="this.addData.contactAddress" size="large" placeholder="站点地点" style="width: 200px" /></p>
      <p><span class="first-title">联系人:</span><Input v-model="this.addData.contactPerson" size="large" placeholder="联系人" style="width: 200px" /></p>
      <p><span class="first-title">联系方式:</span><Input v-model="this.addData.contactPhone" size="large" placeholder="联系方式" style="width: 200px" /></p>
      <p><span class="first-title">备注:</span><Input v-model="this.addData.remark" size="large" placeholder="备注" style="width: 200px" /></p>
    </Modal>
  </div>
</template>
  ...
  export default {
    ...
    methods:{
      ...
      getList(){
        ...
        var _this=this;
        $.ajax({
          url: 'http://api-erp.juwenjiaoyu.com:9000/api/user/'+userId+'/system/selectFunctions',
          data: {
          },
          beforeSend: function(request) {
            request.setRequestHeader("x-access-token", token);
